...
Route::group(['middleware' => ['auth', 'verified']], function () {
    Route::middleware([CheckAdminUserRole::class])->group(function () {
        ...
        Route::get('/author-form/index', [AuthorController::class, 'index'])->name('author.all')->withoutMiddleware([CheckAdminUserRole::class]);
    ...
    Route::middleware([CheckAuthorUserRole::class])->group(function () {
        ...
        Route::get('/publication/view/{id}', [PublicationController::class, 'view'])->name('publication.view');
