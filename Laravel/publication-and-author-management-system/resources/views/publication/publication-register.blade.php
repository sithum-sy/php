                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('publication.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" rows="4" required autocomplete="description" autofocus>{{ old('description') }}</textarea>
